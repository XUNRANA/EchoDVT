...
RF_META = ROOT / "artifacts" / "unified_model" / "rf_unified.json"
MFP_SUMMARY = ROOT / "sam2" / "predictions" / "sam2_lora_yolo_box" / "val_20260315_094056_lora_r8_mfp15" / "summary.json"
RTF_OUTPUT = ROOT / "artifacts" / "tables" / "table7_6_end_to_end_summary.rtf"
TSV_OUTPUT = ROOT / "artifacts" / "tables" / "table7_6_end_to_end_summary.tsv"
