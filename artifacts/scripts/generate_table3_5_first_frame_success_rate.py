...
RTF_OUTPUT = ROOT / "artifacts" / "tables" / "table3_5_first_frame_success_rate.rtf"
TSV_OUTPUT = ROOT / "artifacts" / "tables" / "table3_5_first_frame_success_rate.tsv"
...
def build_rtf(rows):
    cellx = [1400, 2600, 4700, 6800, 9200, 11500, 13800]
    lines = [
        r"{\rtf1\ansi\deff0",
        r"{\fonttbl{\f0\fnil\fcharset134 SimSun;}{\f1\fnil Times New Roman;}}",
        r"\viewkind4\uc1",
        r"\pard\qc\f0\fs21\b " + rtf_escape("表3.5 首帧病例成功率与平均IoU") + r"\b0\par",
        r"\pard\par",
    ]
