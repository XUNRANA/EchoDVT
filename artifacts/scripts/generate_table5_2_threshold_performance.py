...
SAM2_DIR = ROOT / "sam2"
VAL_FEATURES_CSV = ROOT / "artifacts" / "e2e_classify_v3" / "features.csv"
TRAIN_FEATURES_CSV = ROOT / "artifacts" / "train_eval_v3" / "features.csv"
META_JSON = ROOT / "artifacts" / "unified_model" / "rf_unified.json"
RTF_OUTPUT = ROOT / "artifacts" / "tables" / "table5_2_threshold_performance.rtf"
TSV_OUTPUT = ROOT / "artifacts" / "tables" / "table5_2_threshold_performance.tsv"
