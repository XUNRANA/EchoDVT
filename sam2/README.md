...
> EchoDVT fork note: this directory is vendored from Meta SAM 2 and extended for DVT ultrasound video segmentation. For EchoDVT-specific LoRA, MFP, RPA, OKM/DAM, and default checkpoint usage, read [README_EchoDVT.md](README_EchoDVT.md) and the project root [README.md](../README.md). The upstream SAM 2 documentation below is kept for base model installation and API reference.
