...
META_PATH = ROOT / "results" / "unified_model" / "rf_unified.json"
RTF_OUTPUT = ROOT / "results" / "table2_1_echoDVT_system_current_config.rtf"
TSV_OUTPUT = ROOT / "results" / "table2_1_echoDVT_system_current_config.tsv"
